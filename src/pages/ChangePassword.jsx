...
export default function ChangePassword() {
  ...
  const canProceed = allRulesPass && passwordsMatch
  ...
  async function handleSubmit() {
    ...
    sb.from('login_audit').insert({
      ...
      email: profile.username + '@ssccontrol.com',
      event_type: updateErr ? 'password_change_failed' : 'password_change_success',
      ...
      <div className="split-right">
        {step === 'form' && (
          <div className="right-inner">
            ...
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input type={showNew ? 'text' : 'password'} value={confirmPwd}
                  ...
                  onKeyDown={e => e.key === 'Enter' && canProceed && goToConfirm()}
            ...
            <button className="submit-btn" onClick={goToConfirm} disabled={!canProceed}>
              <span>Continue</span>
            </button>
        ...
        {step === 'confirm' && (
          <div className="right-inner">
            ...
            <div className="right-sub">
              ...
              Save it in your password manager or write it down before continuing.
            </div>
            ...
            <div style={{
              padding:'16px 18px', borderRadius:10, background:'#f8fafc',
              ...
              <div style={{
                fontFamily:'var(--mono)', fontSize:18, fontWeight:600, color:'#0f172a',
                wordBreak:'break-all', userSelect:'all', padding:'8px 0'
              }}>
                {newPwd}
              </div>
              <button onClick={copyPwd} type="button" style={{
                marginTop:6, padding:'8px 14px', border:'1px solid #cbd5e1', background:'white',
                borderRadius:6, fontSize:12, fontWeight:500, cursor:'pointer',
                display:'inline-flex', alignItems:'center', gap:6, color:'#0f172a'
              }}>
                {copied ? (
                  <>
            ...
            <label style={{
              ...
              <span style={{ fontSize:13, color:'#92400e', lineHeight:1.5 }}>
                I have <strong>saved this password</strong> (in a password manager, written down,
                or memorised). I understand I will not be able to recover it later.
              </span>
            </label>

            <button className="submit-btn" onClick={handleSubmit} disabled={!savedAck || submitting}>
              {submitting ? <><div className="spinner"/><span>Saving...</span></> : <span>Confirm and update password</span>}
            </button>

            <button style={{marginTop:12,width:'100%',background:'none',border:'none',color:'var(--gray-400)',fontSize:13,cursor:'pointer'}}
              onClick={() => { setStep('form'); setError('') }} disabled={submitting}>← Go back and edit</button>
