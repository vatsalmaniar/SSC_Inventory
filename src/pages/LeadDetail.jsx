                ...
                {activities.map(a => (
                  <div key={a.id} className={'od-activity-item' + (a.activity_type === 'note' || a.activity_type === 'call' || a.activity_type === 'meeting' ? ' od-comment-item' : '')}>
                    {a.activity_type === 'stage_change' ? (
                      ...
                      <>
                        <div className={'od-comment-avatar crm-act-dot-' + a.activity_type} style={{background: a.activity_type==='call'?'#1a73e8':a.activity_type==='meeting'?'#7c3aed':'#d97706', color:'white'}}>
