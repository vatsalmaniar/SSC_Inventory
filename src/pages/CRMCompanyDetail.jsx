...
export default function CRMCompanyDetail() {
  ...
  if (loading) return <Layout pageTitle="CRM — Company" pageKey="crm"><div className="od-page"><div className="loading-state" style={{paddingTop:80}}><div className="loading-spin"/></div></div></Layout>
                  ...
                  {contacts.map(c => (
                    <div key={c.id} style={{padding:'10px 16px',borderBottom:'1px solid var(--gray-50)'}}>
                      ...
                      <div style={{display:'flex',gap:4,marginTop:4,flexWrap:'wrap'}}>
                        {c.is_decision_maker && <span style={{fontSize:9,fontWeight:700,background:'#e8f2fc',color:'#1a73e8',borderRadius:3,padding:'1px 5px'}}>DECISION MAKER</span>}
