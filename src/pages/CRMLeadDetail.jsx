...
export default function CRMLeadDetail() {
  ...
  if (loading) return <Layout pageTitle="Lead" pageKey="crm"><div className="od-page"><div className="loading-state" style={{paddingTop:80}}><div className="loading-spin"/></div></div></Layout>
