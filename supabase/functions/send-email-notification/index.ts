...
const PREF_MAP: Record<string, string> = {
  ...
  credit_approved: 'status_changes', payment_pending: 'status_changes',
  order_edited: 'status_changes', new_customer_approved: 'status_changes',
  po_submitted: 'status_changes', po_approved: 'status_changes',
  po_placed: 'status_changes', po_cancelled: 'status_changes',
...
const TYPE_CONFIG: Record<string, { emoji: string; color: string; bg: string; label: string }> = {
  ...
  // Registered 2026-09-04. These nine were emitting for months with NO entry here, so
  // every one went out as "[SSC] <message snippet>" instead of a real subject —
  // ~7,700 emails, credit_approved alone 4,435. Any new type MUST be added here.
  credit_approved:      { emoji: '', color: '#15803d', bg: '#f0fdf4', label: 'Credit Approved' },
  po_submitted:         { emoji: '', color: '#b45309', bg: '#fffbeb', label: 'Purchase Order Submitted' },
  po_approved:          { emoji: '', color: '#15803d', bg: '#f0fdf4', label: 'Purchase Order Approved' },
  po_placed:            { emoji: '', color: '#1d4ed8', bg: '#eff6ff', label: 'Purchase Order Placed' },
  po_cancelled:         { emoji: '', color: '#dc2626', bg: '#fef2f2', label: 'Purchase Order Cancelled' },
  payment_pending:      { emoji: '', color: '#b45309', bg: '#fffbeb', label: 'Payment Pending' },
  order_edited:         { emoji: '', color: '#1d4ed8', bg: '#eff6ff', label: 'Order Edited' },
  new_customer_approved:{ emoji: '', color: '#15803d', bg: '#f0fdf4', label: 'Customer Approved' },
  sync_down:            { emoji: '', color: '#dc2626', bg: '#fef2f2', label: 'Attendance Sync Down' },
